...
def _draw_props(canvas: Canvas, spec: FrameSpec) -> None:
    ...
    _stamp(canvas, _SET_SQUARE, _PROP_SQUARE[0], _PROP_SQUARE[1] + lift_b)
    _stamp(canvas, _SLATE, _PROP_SLATE[0], _PROP_SLATE[1] + lift_b)
    _stamp(canvas, _CHALK_STICK, _PROP_CHALK[0], _PROP_CHALK[1] + lift_a)
