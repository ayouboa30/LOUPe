...
DefaultDirName={localappdata}\LOUPe\beta-0.1.4
DefaultGroupName=LOUPe beta 0.1.4
DisableProgramGroupPage=yes
PrivilegesRequired=lowest
ArchitecturesAllowed=x64compatible
ArchitecturesInstallIn64BitMode=x64compatible
OutputDir=..\release
OutputBaseFilename=Setup_LOUPe_beta_0.1.4
Compression=lzma2
SolidCompression=yes
WizardStyle=modern
UninstallDisplayName=LOUPe beta 0.1.4
UninstallDisplayIcon={app}\app\3loop.exe
SetupIconFile=..\web\assets\pixel_researcher.ico
VersionInfoDescription=LOUPe beta 0.1.4
VersionInfoProductName=LOUPe beta 0.1.4
...
[Icons]
Name: "{autoprograms}\LOUPe beta 0.1.4"; Filename: "{app}\app\3loop.exe"; WorkingDir: "{app}\app"; Comment: "LOUPe beta 0.1.4"
Name: "{autodesktop}\LOUPe beta 0.1.4"; Filename: "{app}\app\3loop.exe"; WorkingDir: "{app}\app"; Tasks: desktopicon; Comment: "LOUPe beta 0.1.4"
...
Filename: "{app}\app\3loop.exe"; Description: "Lancer LOUPe beta 0.1.4"; Flags: nowait postinstall skipifsilent
