...
$iss = Join-Path $PSScriptRoot "installer\LOUPe_beta_0.1.1.iss"
...
if (-not $iscc) {
  throw "ISCC.exe introuvable. Installe Inno Setup 6 avant de construire Setup_LOUPe_beta_0.1.1.exe."
}
